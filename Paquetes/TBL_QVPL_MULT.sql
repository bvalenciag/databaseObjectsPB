prompt
prompt PACKAGE: TBL_QVPL_MULT
prompt
CREATE OR REPLACE PACKAGE tbl_qvpl_mult IS
--
-- Reúne funciones y procedimientos directamente relacionados con el procedimiento de las cartas vpl Multibank
--
-- #VERSION: 1000
--
-- History
...
/
prompt
prompt PACKAGE BODY: tbl_qvpl_mult
prompt
--
CREATE OR REPLACE PACKAGE BODY tbl_qvpl_mult IS
--
-- #VERSION: 1000
--
FUNCTION ws_fn_acx_fill_sebra (p_traslado tbl_ttrasebra.tras_tras%TYPE
