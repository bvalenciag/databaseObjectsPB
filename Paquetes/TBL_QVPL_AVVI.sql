prompt
prompt PACKAGE: tbl_qvpl_avvi
prompt
CREATE OR REPLACE PACKAGE tbl_qvpl_avvi IS
--
-- Reúne funciones y procedimientos directamente relacionados con el procedimiento de las cartas vpl AvVillas
--
-- #VERSION: 1000
--
-- History
...
/
prompt
prompt PACKAGE BODY: tbl_qvpl_avvi
prompt
--
CREATE OR REPLACE PACKAGE BODY tbl_qvpl_avvi IS
--
-- #VERSION: 1000
--
FUNCTION ws_fn_acx_fill_sebra (p_traslado tbl_ttrasebra.tras_tras%TYPE
