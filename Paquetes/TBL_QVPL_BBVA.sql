prompt
prompt PACKAGE: TBL_QVPL_BBVA
prompt
CREATE OR REPLACE PACKAGE tbl_qvpl_bbva IS
--
-- Reúne funciones y procedimientos directamente relacionados con el procedimiento de las cartas vpl BBVA
--
-- #VERSION: 1000
--
-- History
...
/
prompt
prompt PACKAGE BODY: tbl_qvpl_bbva
prompt
--
CREATE OR REPLACE PACKAGE BODY tbl_qvpl_bbva IS
--
-- #VERSION: 1000
--
FUNCTION ws_fn_acx_fill_sebra (p_traslado tbl_ttrasebra.tras_tras%TYPE
