prompt
prompt PACKAGE: TBL_QVPL_SANT
prompt
CREATE OR REPLACE PACKAGE tbl_qvpl_sant IS
--
-- Reúne funciones y procedimientos directamente relacionados con el procedimiento de las cartas vpl Santander
--
-- #VERSION: 1000
--
-- History
...
-- ========== ========== ============ ============ ============================================================================================================
-- 1000       15/07/2024 Jmartinezm    000001       * Se crea paquete.
--                       Kilonova
-- ========== ========== ============ ============ ============================================================================================================
--
-------------------------------------------------------------------------------------------------
...
/
prompt
prompt PACKAGE BODY: tbl_qvpl_sant
prompt
--
CREATE OR REPLACE PACKAGE BODY tbl_qvpl_sant IS
--
-- #VERSION: 1000
--
FUNCTION ws_fn_acx_fill_sebra (p_traslado tbl_ttrasebra.tras_tras%TYPE
...
SELECT list_sigla                                                                                                                           ing_egr
             ...
             , RTRIM(LTRIM(TO_CHAR((tras_valor+NVL(infb_comision,0)+(NVL(infb_comision_m,0)/tras_valor)),'L99G999G999G999G999G999G999D99MI','NLS_NUMERIC_CHARACTERS = '',.''NLS_CURRENCY = ''$ ''')))                                                                                                                            valor_tras_comi_num
...
BEGIN
    ...
    FOR i IN c_tras LOOP
        ...
        vg_data_sebra(v_count).cargo                := i.cargo                  ;--32 Cargo
